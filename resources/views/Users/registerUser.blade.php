			...
			<div class="wrap-login100 p-t-30 p-b-50">
                ...
                <div>
                    ...
                    <script>
                                    ...
                                    Swal.fire({
                                    title: "Maaf !",
                                    text: "Data Kamu Belum Tersimpan!",
                                    icon: "error"
                                    });
                    </script>
				...
				<form action ="/registerAkunBaru" method="post"class="login100-form validate-form p-b-33 p-t-5">
                        @csrf
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
                        ...
                        <br>
                            <center><h1><a href="/">Sudah Memiliki Akun</a></h1></center>
                        <br>
